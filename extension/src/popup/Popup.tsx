      ...
      {showAuthModal && (
        <div className="bg-white border border-slate-300 rounded-xl p-4 shadow-lg flex flex-col gap-3 my-1 animate-in fade-in">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2 px-3 border border-slate-300 rounded-lg shadow-2xs bg-white hover:bg-slate-50 text-slate-700 text-[11px] font-bold transition disabled:opacity-50"
          >
